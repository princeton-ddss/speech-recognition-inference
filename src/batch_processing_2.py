...
input_features_0 = processor(
    audio_0["array"],
    sampling_rate=audio_0["sampling_rate"],
    return_tensors="pt",
    return_attention_mask=True,
)

input_features_1 = processor(
    audio_1["array"],
...
prompt_ids = processor.get_prompt_ids("thread", return_tensors="pt")
...
transcriptions_batch_nots = processor.batch_decode(
