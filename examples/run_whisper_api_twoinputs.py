...
transcription_inputs = TranscriptionInputs(
    file_name="sample_data_short.wav", language="english", response_format="text"
)
...
json_body_dict = jsonable_encoder(
    {"model_inputs": model_inputs, "transcription_inputs": transcription_inputs}
)
